...
const WMS_NAV = [
  ...
  { group: '库外盘点' },
  { id: 'outside_count_mine', label: '物资盘点', icon: 'fa-box-open', href: 'outside_count_mine.html' },
  { id: 'outside_count_plan_list', label: '盘点计划', icon: 'fa-clipboard-list', href: 'outside_count_plan_list.html' },
  { id: 'outside_count_task_list', label: '盘点进度', icon: 'fa-list-check', href: 'outside_count_task_list.html' },
  { id: 'outside_count_diff_list', label: '差异处理', icon: 'fa-scale-unbalanced', href: 'outside_count_diff_list.html' },
  { id: 'outside_count_report_list', label: '盘点报告', icon: 'fa-chart-pie', href: 'outside_count_report_list.html' },
];
