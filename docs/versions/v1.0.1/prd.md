...
| 产品版本 | V1.0.1 |
| **版本更新时间** | 2026-08-05 |
| **版本迭代说明** | 相对 **v1.0.0** 调整计划采购分流：**急件**计划审核通过后直进物资采购（一计划一单、默认直采、单供应商、需审核）→供货→验收→入库，并作领用依据；**一般**计划审核通过后走 待采→采购申请(JJSQ)→**物资采购**（可多供应商最多 5、唯一中选）→供货→验收→入库，并作领用依据；本期物资采购**移除手工新增入口** |
...
| **一般** | 生成待采；领用依据生效 | 待采 → JJSQ 审核 → **自动生成物资采购** → 多供应商（≤5，唯一中选）→ 采购审核 → **供货→验收→入库** | **是**（申请通过后自动） | **是** |
...
| 6 | 物资采购列表同时有急件与一般；无新增入口 | P0 |
| 7 | 验收协作：经供货发起；计划人与需求人一起验收（文案/流程可辨） | P0 |
