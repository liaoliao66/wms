...
| 产品版本 | V1.0.0 |
| **版本更新时间** | 2026-07-16 |
| **版本迭代说明** | 首版交付：PC 后台 125+ 页 + 独立 App 盘点 11 页；含采购入库、台账、库场/库外盘点、供应商供货单查看修复；按 `global_pipeline` 归档至 `docs/versions/v1.0.0/` |
| 部署区域 | 湖北黄冈武穴 |
| 目标平台 | PC Web + 移动端独立 App（企微 H5 待规划） |
| 交互原型 | [全局总入口](https://liaoliao66.github.io/wms/prototype/index.html) · [v1.0.0 原型门户](https://liaoliao66.github.io/wms/prototype/versions/v1.0.0/index.html) · 162 页 |
